...
let cityname1=await  cityid(cityname);
...
/// to fetch location key/id
    cityid=await fetch( `http://dataservice.accuweather.com/locations/v1/cities/search?apikey=8aZI4psZO7TTBsN4WuFV9mUFyGbjHsAN&q=${cityname}`)
   
    cityid2= await cityid.json()
    city3= cityid2[0]
    console.log(city3)
